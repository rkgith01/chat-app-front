...
const Chat = () => {
  ...
  const connetTows = () => {
    ...
    const ws = new WebSocket(`wss://chat-app-backend-phi-three.vercel.app`);
    // const ws = new WebSocket(`${apiEndPoint.replace(/^http/, 'ws:')}/chat-app-backend-phi-three.vercel.app`);
